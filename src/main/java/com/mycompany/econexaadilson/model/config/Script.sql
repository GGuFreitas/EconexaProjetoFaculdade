...
CREATE TABLE IF NOT EXISTS registro (
    ...
    foto LONGBLOB, -- Garante suporte a imagens grandes no mapa
...
('Parque Centenário limpo', 'Parque Centenário está muito bem cuidado, ótimo para lazer', CURRENT_TIMESTAMP, -23.513, -46.208, 'PENDENTE', 11),
('Asfalto novo no Centro', 'Rua Dr. Deodato Wertheimer recapeada perto da estação', CURRENT_TIMESTAMP, -23.521, -46.188, 'RESOLVIDO', 12),
('Árvore em risco na Vila Oliveira', 'Árvore grande com galhos quebrando na R. Pres. Campos Sales', CURRENT_TIMESTAMP, -23.508, -46.185, 'PENDENTE', 5),
('Movimento no Mercadão', 'Mercado Municipal com grande variedade de produtos locais', CURRENT_TIMESTAMP, -23.522, -46.187, 'PENDENTE', 18);

INSERT INTO usuarios (nome, email, senha_hash, perfil) VALUES
('Admin', 'admin@econexa.com', '$2a$10$AjSLurEZm7CDNM9/98/4KOqwTbUTMTg8JIbcEPtbtqFIljkVfOHwK', 'ADMIN');

-- Simulação de post vinculado ao registro 1
